    ...
    >
      ...
      >
        <div className="relative aspect-[4/3] overflow-hidden bg-bone-deep">
          ...
          {justWorn && (
            <span className="animate-pop absolute inset-x-0 bottom-0 flex items-center justify-center gap-1.5 bg-sage-bright/95 py-2 text-xs font-semibold text-on-bright">
      ...
      <div className="absolute right-2.5 top-2.5 flex flex-col gap-1.5">
        ...
        <button
          ...
          className="flex h-9 w-9 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-shell/85 text-ink-soft opacity-100 backdrop-blur-sm transition-all hover:bg-sage-bright hover:text-on-bright sm:opacity-0 sm:group-hover:opacity-100 focus-visible:opacity-100"
        >
