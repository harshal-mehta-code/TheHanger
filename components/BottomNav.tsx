...
export default function BottomNav() {
  ...
  return (
    <nav
      aria-label="Sections"
      className="fixed inset-x-0 bottom-0 z-40 border-t border-bar-line bg-bar pb-[env(safe-area-inset-bottom)] sm:hidden"
    >
      <div className="flex">
          ...
          return (
            <Link
              ...
              className={`flex flex-1 flex-col items-center gap-1 py-2.5 text-[11px] font-medium transition-colors ${
                active ? "text-berry-bright" : "text-bar-ink/55"
              }`}
            >
